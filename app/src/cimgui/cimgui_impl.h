...
/* FIX: GLFWwindow forward declarations and igImplGlfw_* functions are
   PC-only. Wrap them in #ifndef ANDROID so Android builds don't see
   GLFW types they don't need and can't link against. */
#ifndef ANDROID
